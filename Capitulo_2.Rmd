---
title: "TAREA2_CAP2. Exploratory Data Analysis. Ejercicios"
date: "Febrero 2025"
...
Tenemos en total 70 variables, donde 57 de ellas son numéricas y las 13 restantes son categóricas.
...
De acuerdo a la gráfica, podemos observar que el tipo de vehículo "sportcar" es el menos popular y el más popular es el tipo de vehículo "regcar".
...
new_car |> 
  ggplot(aes(x = type)) + 
  geom_bar(color = "black", fill = "green4") + 
  labs(x = "Tipo de vehículo", y = "Número de respuestas")

new_car |> 
  ggplot(aes(x = fuel)) + 
  geom_bar(color = "black", fill = "pink2") + 
...
De acuerdo a esta boxplot, observamos que, aunque hay variabilidad dentro de cada tipo, los vehículos tipo **stwagon** parecen ser menos contaminantes en promedio. El resto de los tipos tiene distribuciones de contaminación bastante similares.
...
De acuerdo con el violin plot, **regcar** es el más variable en términos de densidad, lo que indica que hay varios tamaños populares dentro de ese tipo.

Los demás tipos parecen tener distribuciones más simétricas o planas, lo cual sugiere que no hay un tamaño claramente dominante.
...
Apartir de esta gráfica de treemap, obtenemos las siguiente conclusiones:

* El tipo de combustible **"Electrico"** es la mejor opción en cuanto a contaminación, independientemente del tipo de vehículo.

* **Gasoline y methanol** tienden a ser los más contaminantes.

* **CNG (gas natural comprimido)** se encuentra en un nivel intermedio.

* El tipo de vehículo **regcar**, como vimos en graficas ateriores, es el más común, y dentro de él hay mucha variabilidad de contaminación según el combustible.
